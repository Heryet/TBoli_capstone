    ...
    <ul class="list-unstyled topbar-menu float-end mb-0">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#"
                ...
                <?php
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        $sql = "SELECT  tbl_userinfo.user_id, tbl_userinfo.firstname, tbl_userinfo.gender, tbl_userinfo.birthday, tbl_userinfo.middlename, tbl_userinfo.lastname,  tbl_user_level.level
                                FROM tbl_learner
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                ...
                <!-- item-->
                <a href="learner_profile.php" class="dropdown-item notify-item">
