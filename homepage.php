...
<head>
  ...
  <link href="assets/css/homepagestyle.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Tboli Literacy and Numeracy</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Login </span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="Learner_login.php">Learner Login </a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/images/hero-img.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  ...
  <script src="assets/js/homepagemain.js"></script>
</body>
