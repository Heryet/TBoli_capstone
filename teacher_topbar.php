                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        $sql = "SELECT tbl_userinfo.user_id, tbl_userinfo.firstname, tbl_userinfo.birthday, tbl_userinfo.gender, tbl_userinfo.middlename, tbl_userinfo.lastname, tbl_user_level.level
                                                FROM tbl_teachers
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                    ...
                                    <span class="account-user-avatar">
                                        <img src="assets/images/users/Jillian-Ward.jpg" alt="user-image"
