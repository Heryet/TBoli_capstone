    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <table id="basic-datatable" class="table table-centered mb-0">
                ...
                <table id="basic-datatable" class="table table-centered mb-0">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="admin_add_new_class.php" class="btn btn-danger mb-2"><i
                                    class="mdi mdi-plus-circle me-2"></i> Add Class</a>
                        </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                                                        <a href="admin_manage_class.php?quiz_options_id=<?php echo $row['section_id']; ?>"
                                                            class="btn btn-success btn-sm">Manage</a>
                                                        <a href="Teacher_Add_QuizMultipleC.php?quiz_options_id=<?php echo $row['section_id']; ?>"
